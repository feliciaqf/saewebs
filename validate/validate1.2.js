(function (factory) {
	...
	FormValidator.prototype.check = function(fieldName,callback) {
	...
	FormValidator.prototype._init = function(name) {
		var field;
		if(name){
	...
	FormValidator.prototype._initField = function(field) {
	...
	FormValidator.prototype._validateForm = function(callback) {
        var success = true;
        this.errors = {};
        this._init();
    	for(var k in this.fields){
