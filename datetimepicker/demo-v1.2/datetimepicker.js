...
(function(){
	...
	function Cd(J,K){
	    ...
	    function My97DP() {
	        ...
	        $d.innerHTML = '<div id=dpTitle><div class="navImg NavImgll"><a></a></div><div class="navImg NavImgl"><a></a></div><div style="float:left"><div class="menuSel MMenu"></div><input class=yminput></div><div style="float:left"><div class="menuSel YMenu"></div><input class=yminput></div><div class="navImg NavImgrr"><a></a></div><div class="navImg NavImgr"><a></a></div><div style="float:right"></div></div><div style="position:absolute;overflow:hidden"></div><div></div><div id=dpTime><div class="menuSel hhMenu"></div><div class="menuSel mmMenu"></div><div class="menuSel ssMenu"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span class=dpTimeStr></span>&nbsp;<input class=tB maxlength=2><input value=":" class=tm readonly><input class=tE maxlength=2><input value=":" class=tm readonly><input class=tE maxlength=2></td><td class="wdatef0"><button class=dpTimeUp></button></td></tr><tr><td class="wdatef0"><button class=dpTimeDown></button></td></tr></table></div><div id=dpQS></div><div id=dpControl><input class=dpButton id=dpClearInput type=button><input class=dpButton id=dpTodayInput type=button><input class=dpButton id=dpOkInput type=button></div>';
	    ...
	    My97DP.prototype = {
	        ...
	        draw: function() {
	            ...
	            if ($dp.doubleCalendar) {
	                ...
	                $.a("</td></tr></table>");
	                $d.dDiv.innerHTML = $.j();
	                if($dp.has.st && $cfg.doubleValue){
	                	var str = $d.tDiv.innerHTML,
	                		tIdx = str.indexOf("<table"),
	                		rstr = str.substring(0,tIdx);
	                		tstr = str.substring(tIdx);
	                	$d.tDiv.className += "dobuleTime";
		                $ = new sb();
		                $.a(rstr);
